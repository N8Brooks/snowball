...
const a_13: Rule[] = [["\u0627\u062A", -1, 1]];

const a_14: Rule[] = [["\u062A", -1, 1]];

const a_15: Rule[] = [["\u0629", -1, 1]];

const a_16: Rule[] = [["\u064A", -1, 1]];
          ...
          lab3: {
            ...
            switch (among_var) {
              case 1:
                ...
                break;
              case 2:
                if (!this.slice_from("0")) {
                  return false;
                }
                break;
              case 3:
                if (!this.slice_from("1")) {
                  return false;
                }
                break;
              case 4:
                if (!this.slice_from("2")) {
                  return false;
                }
                break;
              case 5:
                if (!this.slice_from("3")) {
                  return false;
                }
                break;
              case 6:
                if (!this.slice_from("4")) {
                  return false;
                }
                break;
              case 7:
                if (!this.slice_from("5")) {
                  return false;
                }
                break;
              case 8:
                if (!this.slice_from("6")) {
                  return false;
                }
                break;
              case 9:
                if (!this.slice_from("7")) {
                  return false;
                }
                break;
              case 10:
                if (!this.slice_from("8")) {
                  return false;
                }
                break;
              case 11:
                if (!this.slice_from("9")) {
                  return false;
                }
                break;
              case 12:
                if (!this.slice_from("\u0621")) {
                  return false;
                }
                break;
              case 13:
                if (!this.slice_from("\u0623")) {
                  return false;
                }
                break;
              case 14:
                if (!this.slice_from("\u0625")) {
                  return false;
                }
                break;
              case 15:
                if (!this.slice_from("\u0626")) {
                  return false;
                }
                break;
              case 16:
                if (!this.slice_from("\u0622")) {
                  return false;
                }
                break;
              case 17:
                if (!this.slice_from("\u0624")) {
                  return false;
                }
                break;
              case 18:
                if (!this.slice_from("\u0627")) {
                  return false;
                }
                break;
              case 19:
                if (!this.slice_from("\u0628")) {
                  return false;
                }
                break;
              case 20:
                if (!this.slice_from("\u0629")) {
                  return false;
                }
                break;
              case 21:
                if (!this.slice_from("\u062A")) {
                  return false;
                }
                break;
              case 22:
                if (!this.slice_from("\u062B")) {
                  return false;
                }
                break;
              case 23:
                if (!this.slice_from("\u062C")) {
                  return false;
                }
                break;
              case 24:
                if (!this.slice_from("\u062D")) {
                  return false;
                }
                break;
              case 25:
                if (!this.slice_from("\u062E")) {
                  return false;
                }
                break;
              case 26:
                if (!this.slice_from("\u062F")) {
                  return false;
                }
                break;
              case 27:
                if (!this.slice_from("\u0630")) {
                  return false;
                }
                break;
              case 28:
                if (!this.slice_from("\u0631")) {
                  return false;
                }
                break;
              case 29:
                if (!this.slice_from("\u0632")) {
                  return false;
                }
                break;
              case 30:
                if (!this.slice_from("\u0633")) {
                  return false;
                }
                break;
              case 31:
                if (!this.slice_from("\u0634")) {
                  return false;
                }
                break;
              case 32:
                if (!this.slice_from("\u0635")) {
                  return false;
                }
                break;
              case 33:
                if (!this.slice_from("\u0636")) {
                  return false;
                }
                break;
              case 34:
                if (!this.slice_from("\u0637")) {
                  return false;
                }
                break;
              case 35:
                if (!this.slice_from("\u0638")) {
                  return false;
                }
                break;
              case 36:
                if (!this.slice_from("\u0639")) {
                  return false;
                }
                break;
              case 37:
                if (!this.slice_from("\u063A")) {
                  return false;
                }
                break;
              case 38:
                if (!this.slice_from("\u0641")) {
                  return false;
                }
                break;
              case 39:
                if (!this.slice_from("\u0642")) {
                  return false;
                }
                break;
              case 40:
                if (!this.slice_from("\u0643")) {
                  return false;
                }
                break;
              case 41:
                if (!this.slice_from("\u0644")) {
                  return false;
                }
                break;
              case 42:
                if (!this.slice_from("\u0645")) {
                  return false;
                }
                break;
              case 43:
                if (!this.slice_from("\u0646")) {
                  return false;
                }
                break;
              case 44:
                if (!this.slice_from("\u0647")) {
                  return false;
                }
                break;
              case 45:
                if (!this.slice_from("\u0648")) {
                  return false;
                }
                break;
              case 46:
                if (!this.slice_from("\u0649")) {
                  return false;
                }
                break;
              case 47:
                if (!this.slice_from("\u064A")) {
                  return false;
                }
                break;
              case 48:
                if (!this.slice_from("\u0644\u0627")) {
                  return false;
                }
                break;
              case 49:
                if (!this.slice_from("\u0644\u0623")) {
                  return false;
                }
                break;
              case 50:
                if (!this.slice_from("\u0644\u0625")) {
                  return false;
                }
                break;
              case 51:
                if (!this.slice_from("\u0644\u0622")) {
                  return false;
                }
                break;
            }
    ...
    while (true) {
      ...
      lab2: {
        lab3: {
          ...
          lab4: {
            this.bra = this.cursor;
            const among_var = this.find_among(a_2);
            if (among_var == 0) {
              break lab4;
            }
            this.ket = this.cursor;
