  ...
  private r_mark_regions() {
    ...
    lab0: {
      lab1: {
        ...
        lab2: {
          if (!this.in_grouping(g_v, 97, 117)) {
            break lab2;
          }
          lab3: {
            const v_3 = this.cursor;
            lab4: {
              if (!this.out_grouping(g_v, 97, 117)) {
                break lab4;
              }
              golab5:
              while (true) {
  ...
  private r_aditzak() {
    ...
    switch (among_var) {
      ...
      case 2:
        ...
        break;
      case 3:
        if (!this.slice_from("atseden")) {
          return false;
        }
        break;
      case 4:
        if (!this.slice_from("arabera")) {
          return false;
        }
        break;
      case 5:
        if (!this.slice_from("baditu")) {
          return false;
        }
        break;
    }
  ...
  private r_izenak() {
    ...
    switch (among_var) {
      ...
      case 4:
        ...
        break;
      case 5:
        if (!this.slice_from("tra")) {
          return false;
        }
        break;
      case 6:
        if (!this.slice_from("minutu")) {
          return false;
        }
        break;
      case 7:
        if (!this.slice_from("zehar")) {
          return false;
        }
        break;
      case 8:
        if (!this.slice_from("geldi")) {
          return false;
        }
        break;
      case 9:
        if (!this.slice_from("igaro")) {
          return false;
        }
        break;
      case 10:
        if (!this.slice_from("aurka")) {
          return false;
        }
        break;
    }
